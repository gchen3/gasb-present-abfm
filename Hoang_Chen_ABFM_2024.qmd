...
-   Statements 67 and 68 establish standards for measuring and recognizing net pension liabilities, which enhance the transparency, understandability, consistency, and usefulness of pension information for users of government financial reports.
...
## Change of Blended Discount Rates and Rate of Return Assumptions
...
-   **Control Variables: plan characteristic variables**:
    - percent of required contribution paid, amortization period, asset smoothing period, normal cost rate, 5-year average investment return, 
    - retiree to worker ratio, open or closed amortization method, total membership (log), Social Security coverage (yes or no), open or closed plan, employment types (teachers, police and firefighter, or general public employees), and plan types (multi-employer plans and single plans)
...
Trang Hoang 
[tranghoang@unomaha.edu](mailto:tranghoang@unomaha.edu)

Gang Chen 
[gchen3@albany.edu](mailto:gchen3@albany.edu)
